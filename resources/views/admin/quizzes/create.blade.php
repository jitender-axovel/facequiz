...
@section('content')
<div class="row">
    <h2 class="user-heading">Add New Quiz</h2>
    <hr>
            ...
            <form action="{{ url('admin/quiz') }}" method="POST" class="form-horizontal" enctype="multipart/form-data">
                ...
                <fieldset class="jumbotron">
                    ...
                    <div class="form-group">
                        ...
                        <label class="col-md-2">Show Friends Pictures</label>
                        <div class="col-md-1 cmn-checkbox">
